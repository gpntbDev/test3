                ...
                <table style="background-color: #fff; border-radius: 10px;" align="center" cellpadding="0"
                    ...
                    <tr>
                        <td
                            ...
                            Добро пожаловать в сообщество читателей <a href="http://www.spsl.nsc.ru/">ГПНТБ СО РАН</a>.
                            Мы рады, что вы теперь с нами :-)
                        </td>
                    </tr>
                    <tr>
                        <td
                            style="padding-left:40px; padding-right:40px; padding-top:20px; font-size: 14px; line-height: 19px; font-family: Arial, Helvetica, sans-serif; font-style: normal;">
                            Чтобы подтвердить регистрацию, перейдите по ссылке ниже.
                        </td>
                    </tr>
                    <tr>
                        <td
                            style="padding-left:40px; padding-bottom:20px; color: #fff; padding-right:40px; padding-top:20px;">
                            <table style="border-radius:8px; background-color: #035BA0;" align="center" border="0"
                                cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="40" align="center"
                                        style="font-size: 14px; line-height: 19px; font-family: Arial, Helvetica, sans-serif; font-style: normal; font-weight: bold;">
                                        <a href="http://auth.gpntbsib.ru:3000/confirm-email/${code}"
                                            style="padding: 30px; text-decoration: none; color: #FFF; text-align: center;">Подтвердить
                                            E-mail</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td
                            style="padding-left:40px; padding-right:40px; font-size: 14px; line-height: 19px; font-family: Arial, Helvetica, sans-serif; font-style: normal;">
                            Не забудьте заполнить аккаунт, чтобы он стал более живым.
                        </td>
                    </tr>
                    <tr>
                        <td
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" width="600">
                    <tr>
                        <td align="center"
                            ...
                            Вы
                            получили это
                            письмо, так как указали свой email при регистрации на сайте ГПНТБ СО РАН.
                        </td>
                    </tr>
                </table>
